...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ViewHolder> {
    private Narrative[] narrativeSet;
    ...
    public void onBindViewHolder(@NonNull ForecastAdapter.ViewHolder holder, int position) {
        ...
        TextView narrativeField = (TextView)holder.itemView.findViewById(R.id.narrativeTextField);
        TextView daypartNameField = (TextView)holder.itemView.findViewById(R.id.dayLabel);
